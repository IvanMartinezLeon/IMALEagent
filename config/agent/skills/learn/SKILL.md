...
- [ ] **Fase 1: Evaluación del Contexto**
  - Identificar qué está intentando aprender o configurar el usuario.
- [ ] **Fase 2: Explicación Conceptual**
  - Explicar el concepto usando analogías o referencias a la documentación oficial del proyecto.
- [ ] **Fase 3: Ejemplo Práctico**
  - Proporcionar un fragmento de código o un comando de ejemplo que el usuario pueda probar inmediatamente.
- [ ] **Fase 4: Verificación de Comprensión**
  - Preguntar al usuario si la explicación fue clara o si necesita profundizar en algún punto específico.
